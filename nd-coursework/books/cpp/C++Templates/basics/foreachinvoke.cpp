...
{
public:
    void memfunc(int i) const { std::cout << "MyClass::memfunc() called for: " << i << '\n'; }
};
...
int main()
{
    ...
    foreach (
        primes.begin(),
        primes.end(),                            // elements for 2nd arg of lambda
    ...
    foreach (primes.begin(),
        primes.end(),        // elements used as args
        &MyClass::memfunc,   // member function to call
        obj)
        ;   // object to call memfunc() for
}
