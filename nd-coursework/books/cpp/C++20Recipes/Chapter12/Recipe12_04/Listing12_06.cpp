...
//
// Name: Listing12_06.cpp
// Author: crdrisko
// Date: 10/12/2020-12:55:45
// Description: Creating a program that can receive data
...
int main(int argc, const char* argv[])
{
    ...
    std::stringstream data {acceptResult.Receive()};
    std::string message;
    std::getline(data, message, '\0');
