...
// Name: Ex8_16.cpp
// Author: crdrisko
// Date: 10/21/2020-06:54:19
// Description: Overloading a function with reference parameters
...
int main()
{
    ...
    std::cout << "The larger of double values " << a_double << " and " << b_double << " is " << larger(a_double, b_double)
              << std::endl;
