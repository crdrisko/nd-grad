...
|* Name: Ex8_15.cpp                                          *|
|* Author: crdrisko                                          *|
|* Date: 05/21/19-13:21:35                                   *|
|* Description: Overloading a function                       *|
|*                                                           *|
|*                                                           *|
|* Complile Command: g++ Ex8_15.cpp -o Ex8_15.out -std=c++17 *|
\*************************************************************/
...
// Finds the largest of a array of double values
double largest(const double data[], size_t count)
{
    double max {data[0]};
...
// Finds the largest of a vector of string values
string largest(const vector<string>& words)
{
