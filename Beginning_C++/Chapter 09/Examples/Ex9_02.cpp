...
|* Name: Ex9_02.cpp                                          *|
|* Author: crdrisko                                          *|
|* Date: 06/06/19-10:16:37                                   *|
|* Description: Using overloaded function templates          *|
|*                                                           *|
|*                                                           *|
|* Complile Command: g++ Ex9_02.cpp -o Ex9_02.out -std=c++17 *|
\*************************************************************/
...
// Function template overload to return the largest of two values pointed to by pointers
template <typename T> T* larger(T* a, T* b)
{
    return *a > *b ? a : b;
}
