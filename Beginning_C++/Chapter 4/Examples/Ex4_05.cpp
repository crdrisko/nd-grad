...
|* Name: Ex4_05.cpp                                          *|
|* Author: crdrisko                                          *|
|* Description: Combining logical operators for loan         *|
|*  approval                                                 *|
|*                                                           *|
|*                                                           *|
|* Complile Command: g++ Ex4_05.cpp -o Ex4_05.out -std=c++17 *|
\*************************************************************/
...
int main()
{
    ...
    // We will only lend to people who are over 21 years of age,
